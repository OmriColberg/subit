...
async def align_with_transcript(data: dict, request: Request):
    ...
    system = (
        ...
        "6. לפני שאתה מחזיר תשובה: ודא שכל מילות הטקסט המדויק חולקו — "
        "הסכום חייב להיות שווה. אם חסרות מילים בסוף — חזור ותחלק מחדש "
        "עם פחות מילים לכתוביות הקודמות. אסור לקצר או לוותר על מילים.\n\n"
